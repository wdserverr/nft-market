...
import { AiOutlineHeart, AiFillHeart, AiFillDownCircle, AiFillDollarCircle } from "react-icons/ai";
      ...
      child={<>
        ...
        <div className="wrapper">
          <div className="info-container">
            <p className="owner"> khongfkers.near <AiFillDownCircle /> </p>
            <p className="name">Fkers #1</p>
          </div>
          ...
          <div className="price-container">
            ...
            <p className="price">
              {" "}
              <AiFillDollarCircle size="25px" color="white"/>4.555
            </p>
          </div>
        </div>
